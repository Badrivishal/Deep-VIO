...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("experiments\colab_reg_big\DeepVIO.modelepoch43.model.pth"))
    ...
    test_loader = torch.utils.data.DataLoader(test_dataset, 2, shuffle=False, num_workers=4, pin_memory=True)
